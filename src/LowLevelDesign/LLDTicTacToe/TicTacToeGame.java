    ...
    public String startGame() {
        ...
        while (noWinner) {
            ...
            try {
                ...
                System.out.println("Invalid Arguments, Please provide Integer Value and try again");
                players.addFirst(playerTurn);
                continue;
                //throw new RuntimeException("Invalid Arguments");
            }

            boolean checkValidMove = gameBoard.checkValidCell(inputRow, inputColumn);
            if (!checkValidMove) {
            ...
            if (!pieceAddedSuccessfully) {
                ...
                System.out.println("position Already chosen, Please try again");
                players.addFirst(playerTurn);
                continue;
            }
